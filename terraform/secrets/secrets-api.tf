  ...
  data_json = jsonencode(
    {
      ...
      DATABASE_URL_WO_SCHEMA = "postgresql://${local.api_db_username}:${resource.random_password.postgresql_password_dev.result}@${local.default_db_host}:5432/${local.api_db}",
  ...
  data_json = jsonencode(
    {
      ...
      DATABASE_URL_WO_SCHEMA = "postgresql://${local.api_db_username}:${resource.random_password.postgresql_password_sta.result}@${local.default_db_host}:5432/${local.api_db}",
      DB_DEFAULT_SCHEMA = local.api_db_default_schema,
      DB_HOST = local.default_db_host,
      DB_PORT = 5432,
  ...
  data_json = jsonencode(
    {
      ...
      DATABASE_URL_WO_SCHEMA = "postgresql://${local.api_db_username}:${local.rds_master_password}@${local.rds_db_endpoint}:5432/${local.api_db}",
      DB_DEFAULT_SCHEMA = local.api_db_default_schema,
